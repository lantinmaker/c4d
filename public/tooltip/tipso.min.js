	...
	DarkTooltip.prototype = {
		...
		setContent: function(){
			...
			if(this.options.content){
				...
				console.log("attr:" + this.bearer.attr('id'));
			...
			this.tooltip = $("<div class = 'dark-tooltip " + this.options.theme + " " + this.options.size + " "
				+ this.options.gravity + "'><div>" + this.content + "</div><div class = 'tip'></div></div>");
		...
		setPositions: function(){
			...
			switch(this.options.gravity){
				case 'south':
					...
					break;
				case 'west':
					leftPos = this.bearer.outerWidth() + 26;
					console.log(this.bearer)
					topPos =  this.bearer.outerHeight()/2 - (this.tooltip.outerHeight()/2) + 6;
					break;
				case 'north':
					leftPos = bearerLeft + this.bearer.outerWidth()/2 - (this.tooltip.outerWidth()/2);
